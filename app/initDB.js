    ...
    return {
     ...
     allTransactions: function(db) {
	   ...
	   // $cordovaSQLite.execute(db, "INSERT INTO `tema` VALUES (3,'Mitosis');");
	    ...
	    $cordovaSQLite.execute(db, "CREATE TABLE IF NOT EXISTS'hace-ejer' (`nickUsuario` TEXT NOT NULL,`idEjer`  INTEGER NOT NULL,PRIMARY KEY(nickUsuario,idEjer),FOREIGN KEY(`nickUsuario`) REFERENCES usuario(nick),FOREIGN KEY(`idEjer`) REFERENCES ejercicio(id));");
