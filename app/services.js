...
.factory('DB', function($cordovaSQLite) {
  ...
  return{
    ...
    create: function(){
      ...
      $cordovaSQLite.execute(db, "CREATE TABLE IF NOT EXISTS`resuelve-test` (`nickUsuario` INTEGER NOT NULL,`idTest`  INTEGER NOT NULL, `idTema`  INTEGER NOT NULL,`esAcierto` INTEGER NOT NULL, PRIMARY KEY(nickUsuario,idTest),FOREIGN KEY(`nickUsuario`) REFERENCES usuario(nick),FOREIGN KEY(`idTema`) REFERENCES tema(id), FOREIGN KEY(`idTest`) REFERENCES test(id));");
